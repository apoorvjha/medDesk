...
def intents_fetch():
	if request.method=='GET':
		...
		#	break		
		#response+='<tr>'
		#response+='<td><input type="text" name="tag" id="tag" placeholder="Tag"></td>'
		#response+='<td><input type="text" name="pattern" id="pattern" placeholder="Pattern"></td>'
		#response+='<td><input type="text" name="responses" id="responses" placeholder="Responses"></td>'
		#response+='<td><input type="text" name="action" id="action" placeholder="Action"></td>'
		#response+='<td><input type="text" name="context" id="context" placeholder="Context"></td>'
		#response+='<td><input type="submit" value="add" class="activate" onClick="addIntent()"></td>'
		#response+='</table>'
		return response
